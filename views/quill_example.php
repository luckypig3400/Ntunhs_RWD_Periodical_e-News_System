        ...
        <section class="blog">
            <div class="container" data-aos="fade-up">
                ...
                <div id="editor">
                    ...
                    <p>
                        <?php
                        $text = "學生自治性的團體，一直以來在各大專院校都是很努力經營的，它代表了學生的自治性，也是學生跟學校溝通的一個管道，學生的許多意見表達並不一定會得到校方的回應，但如果我們可以藉由學生自治性的團體替我們做一個柔性的溝通，相信校方會有適當的回應，這幾年來許多大專院校的自治性的團體都有著後繼無人的危機存在，看到北護同學對於這次學生生會改選這麼的熱情參與，真的是有說不出的感動，但是選舉結果總是殘酷的，相信全校的學生選出了他們可以信賴為他們服務的候選人，也相信他們不會辜負同學對他們的期望，讓北護更加的生氣蓬勃，以下就是我們的選舉結果：
