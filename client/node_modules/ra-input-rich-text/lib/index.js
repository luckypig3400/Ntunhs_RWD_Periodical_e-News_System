...
var RichTextInput = function (props) {
    ...
    var _e = (0, ra_core_1.useInput)(__assign({ source: source }, rest)), id = _e.id, isRequired = _e.isRequired, _f = _e.input, value = _f.value, onChange = _f.onChange, _g = _e.meta, touched = _g.touched, error = _g.error;
    ...
    return (react_1.default.createElement(core_1.FormControl, { error: !!(touched && error), fullWidth: fullWidth, className: "ra-rich-text-input", margin: margin },
        react_1.default.createElement(core_1.InputLabel, { shrink: true, htmlFor: id, className: classes.label },
